...
{
    public class HandDataSlow : MonoBehaviour
    {
        ...
        void Start()
        {
            if(newFile)
            {
                ...
                WriteString("discrete,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,discrete,discrete,discrete,discrete,discrete,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,continuous,discrete,discrete,discrete,discrete,discrete,continuous");
                if (ButtonManager.CurrentWord != "")
                    WriteString("class,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,");
                else
                    WriteString(",,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,");
        ...
        void Update()
        {
            ...
            else if(i == 0)
            {
                ...
                if(ButtonManager.CurrentWord == "")
                {
                    InvokeRepeating("CollectData", 0, 0.05f);
                }
                else
                {
                    InvokeRepeating("CollectData", 0, 0.05f);
